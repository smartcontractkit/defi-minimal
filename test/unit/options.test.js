        ...
        let owner, writer, buyer
            ...
            describe("Option parameters", async() => {
                ...
                describe("Writing a call", async() => {
                    ...
                    const writeCall = await options.writeCallOption(amount, strike, premiumDue, daysToExpiry, daiAmount, {from: writer, value:1})
                ...
                describe("Buy call options", async() => {
                    ...
                    it("Should emit buy call option event", async() => {
                        await options.writeCallOption(amount, strike, premiumDue, daysToExpiry, daiAmount, {from: writer, value:1})
                ...
                describe("Write a put option contract", async() => {
                    ...
                    const writePut = await options.writePutOption(amount, strike, premiumDue, daysToExpiry,daiAmount, {from: writer, value: 1})
                    it("Should use correct parameters", async() => {
                        expect(amount).to.equal(1);
                        expect(strike).to.equal(1000);
                        expect(premiumDue).to.equal(1);
                ...
                describe("Buy put option", async() => {
                    ...
                    it("Should emit buy put option event", async() => {
                        await options.writePutOption(amount, strike, premiumDue, daysToExpiry,daiAmount, {from: writer, value:1})
                ...
                describe("Exercise call options", async() => {
                    ...
                    it("Should fail to emit event call option exercised because spot not greater than strike...", async() => {
                        ...
                        await expect(options.exerciseCallOption(0, 1000,{from: buyer})).to.be.reverted  
                    })
                ...
                describe("Exercise put options", async() => {
                    ...
                    it("Should fail to emit event put option exercised because spot is not less than strike...", async() => {
                        ...
                        await expect(options.exercisePutOption(0, 1000, {from: buyer})).to.be.reverted
                ...
                describe("Option expires worthless", async() => {
                    ...
                    it("Should fail to emit event b/c call option is not worthless if spot not less than strike...", async() => {
                        ...
                        await expect(options.optionExpiresWorthless(0, 1000, {from: buyer})).to.be.reverted 
